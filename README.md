...
## ImageNet1K
Distributed training to achieve ~78% test accuracy with ViT-S/16 for 90epochs in ~6hours, replicating and slightly improving the results of [Beyer et al. 2022](https://arxiv.org/pdf/2205.01580). 
